    ...
    <div>
      ...
      <div className="flex flex-col gap-3">
        {q.opts[lang].map((opt, i) => {
          ...
          if (selected === null) cls += 'border-gray-700 bg-gray-800 hover:border-purple-500 cursor-pointer'
...
function Reflections({ lang, onComplete }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {submitted && <p className="text-green-400 font-bold text-center">{lang === 'en' ? '🧠 Reflections saved. Thank you!' : '🧠 Refleksi disimpan. Terima kasih!'}</p>}
    </div>
  )
}
