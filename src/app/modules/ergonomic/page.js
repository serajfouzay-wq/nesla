  ...
  return (
    <div className="min-h-screen pb-10">
      ...
      <div className="pt-24 max-w-2xl mx-auto px-4">
        <h1 className="text-2xl font-black text-white mb-4">🪑 Ergonomic</h1>
        <div className="card-hud">
          <h3 className="font-bold mb-1 text-white">{lang === 'en' ? 'Spot the Correct Posture' : 'Kesan Postur Yang Betul'}</h3>
          <p className="text-sm text-gray-400 mb-4">{lang === 'en' ? 'Tap the image showing the correct ergonomic posture.' : 'Ketik imej yang menunjukkan postur ergonomik yang betul.'}</p>
          {score !== null ? (
